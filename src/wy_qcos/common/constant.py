...
class Constant:
    ...
    DEFAULT_MIN_UPDATE_METRICS_INTERVAL_SECONDS = 5
    DEFAULT_MAX_UPDATE_METRICS_INTERVAL_SECONDS = 120
    DEFAULT_METRICS_UPDATE_CHANNEL = "qcos:metrics:update_channel"
