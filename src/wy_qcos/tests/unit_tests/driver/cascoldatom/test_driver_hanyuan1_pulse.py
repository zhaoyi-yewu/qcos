...
from wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse import (
    DriverHanyuan1Pulse,
)
...
class TestDriverHanyuan1Pulse:
    ...
    @patch(
        "wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse.smbclient.register_session"
    )
    ...
    @patch(
        "wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse.smbclient.reset_connection_cache"
    )
    @patch(
        "wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse.smbclient.register_session"
    )
    ...
    @patch(
        "wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse.smbclient.open_file"
    )
    @patch(
        "wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse.smbclient.path.exists"
    )
    @patch("wy_qcos.driver.cascoldatom.driver_hanyuan1_pulse.smbclient.mkdir")
