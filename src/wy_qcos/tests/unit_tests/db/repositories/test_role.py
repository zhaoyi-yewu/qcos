...
class TestRoleRepositoryCRUD:
    ...
    def test_update_role_not_found(self, role_repository):
        ...
        success, error, result = role_repository.update_role(fake_id, update_request)
        assert success is False
        assert result is None

    def test_update_role_filters_none_values(self, role_repository, sample_role):
    ...
    def test_update_role_when_role_not_found(self, role_repository):
        ...
        with patch.object(role_repository, 'get_by_uuid') as mock_get:
            mock_get.return_value = (False, "Not found", None)
            update_request = UpdateRoleRequest(role_id='id', permissions=['read'])
            success, error, updated = role_repository.update_role('id', update_request)
            assert success is False

    def test_update_role_when_update_failed(self, role_repository, sample_role):
...
class TestRoleRepositoryExceptionHandling:
    ...
    def test_update_role_exception_handling(self, role_repository, sample_role):
