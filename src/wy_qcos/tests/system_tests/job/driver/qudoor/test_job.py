...
from .qudoor_abaqu100_api_server import main
...
class TestJob:
    ...
    def setup_class(cls):
        ...
        cls.api_port = 8081
        cls.abaqu100_process = multiprocessing.Process(
            target=main,
            daemon=True,
            kwargs={"port": cls.api_port},
        )
        cls.abaqu100_process.start()
        ...
        assert connected, (
            f"Failed to connect to qudoor_abaqu100 mock server at "
    ...
    def teardown_class(cls):
        ...
        StLibrary.cleanup_test_jobs(cls.admin_client, cls.test_job_names)
        print("Stop AbaQu100 server")
        cls.abaqu100_process.terminate()

    @pytest.mark.smoke
    def test_submit_job(self):
        job_info = {
            "job_id": str(Library.create_uuid(prefix=[0xF0])),
            "job_name": "test_abaqu100_submit_job",
            ...
            "description": "description: test_abaqu100_submit_job",
            "backend": "qudoor_abaqu100",
            "shots": 1024,
