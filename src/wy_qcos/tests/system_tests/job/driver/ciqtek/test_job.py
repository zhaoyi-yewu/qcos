...
from wy_qcos.tests.system_tests.job.driver.ciqtek.ion_1_api_server import main
...
class TestJob:
    ...
    def setup_class(cls):
        ...
        cls.ion_1_process = multiprocessing.Process(target=main, daemon=True)
        cls.ion_1_process.start()
    ...
    def teardown_class(cls):
        ...
        StLibrary.cleanup_test_jobs(cls.admin_client, cls.test_job_names)
        print("Stop ION TRAP server")
        cls.ion_1_process.terminate()

    @pytest.mark.smoke
    def test_submit_job(self):
        job_info = {
            "job_id": str(Library.create_uuid(prefix=[0xF0])),
            "job_name": "test_ciqtek_ion_1_submit_job",
            ...
            "description": "description: test_ciqtek_ion_1_submit_job",
            "backend": "ciqtek_ion_1",
            "shots": 100,
