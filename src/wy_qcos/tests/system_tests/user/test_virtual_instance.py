...
class TestVirtualInstanceAuth:
    ...
    def test_virtual_instance_auth_mode_switch_and_operations(self):
        ...
        device_names = ["dummy"]
        instance_id = "10000000-0000-4000-8000-000000000100"
    ...
    def test_virtual_instance_single_device_isolation(self):
        ...
        dummy_instance_id = "10000000-0000-4000-8000-000000000100"
        success, err_msg, encrypted_instance_id = (
            Library.encrypt_virtual_instance_id(
                dummy_device_names,
                dummy_instance_id,
    ...
    def test_virtual_instance_two_clients_different_devices(self):
        ...
        dummy_device_names = ["dummy"]
        dummy_instance_id = "10000000-0000-4000-8000-000000000100"
        success, err_msg, dummy_vi_id = Library.encrypt_virtual_instance_id(
            dummy_device_names,
            dummy_instance_id,
            salt=self.password_salt,
            encode=True,
        ...
        # Different from dummy
        qutip_instance_id = "10000000-0000-4000-8000-000000000101"
        success, err_msg, qutip_vi_id = Library.encrypt_virtual_instance_id(
            qutip_device_names,
            qutip_instance_id,
            salt=self.password_salt,
            encode=True,
    ...
    def test_virtual_instance_two_clients_multiple_devices(self):
        ...
        instance_id_1 = "10000000-0000-4000-8000-000000000102"
        ...
        instance_id_2 = "10000000-0000-4000-8000-000000000103"
    ...
    def test_virtual_instance_device_access_control(self):
        ...
        try:
            ...
            assert f"no such device: {unauthorized_device_name}" in str(e)
