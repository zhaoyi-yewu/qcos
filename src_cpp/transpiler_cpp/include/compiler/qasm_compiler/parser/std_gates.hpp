...
const std::map<std::string, std::shared_ptr<Gate>> STANDARD_GATES = {
    ...
    {"U1", std::make_shared<StandardGate>(StandardGate({0, 1, 1, qc::otP}))},
    {"phase",
     std::make_shared<StandardGate>(StandardGate({0, 1, 1, qc::otP}))},

    {"cu", std::make_shared<StandardGate>(StandardGate({1, 1, 4, qc::otCU}))},
    {"CU", std::make_shared<StandardGate>(StandardGate({1, 1, 4, qc::otCU}))},

    {"cu3",
     std::make_shared<StandardGate>(StandardGate({1, 1, 3, qc::otCU3}))},
    {"CU3",
     std::make_shared<StandardGate>(StandardGate({1, 1, 3, qc::otCU3}))},

    {"cphase",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCP}))},
    ...
    {"cx",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCNOT}))},
    {"CX",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCNOT}))},
    {"cnot",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCNOT}))},
    ...
    {"ccx",
     std::make_shared<StandardGate>(StandardGate({2, 1, 0, qc::otTOFFOLI}))},
    {"CCX",
     std::make_shared<StandardGate>(StandardGate({2, 1, 0, qc::otTOFFOLI}))},
    {"toffoli",
     std::make_shared<StandardGate>(StandardGate({2, 1, 0, qc::otTOFFOLI}))},
    ...
    {"ccz",
     std::make_shared<StandardGate>(StandardGate({2, 1, 0, qc::otCCZ}))},
    {"CCZ",
     std::make_shared<StandardGate>(StandardGate({2, 1, 0, qc::otCCZ}))},

    {"c4x",
     std::make_shared<StandardGate>(StandardGate({1, 4, 0, qc::otC4X}))},
    {"C4X",
     std::make_shared<StandardGate>(StandardGate({1, 4, 0, qc::otC4X}))},
    ...
    {"crx",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCRX}))},
    {"CRX",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCRX}))},
    ...
    {"cry",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCRY}))},
    {"CRY",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCRY}))},
    ...
    {"crz",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCRZ}))},
    {"CRZ",
     std::make_shared<StandardGate>(StandardGate({1, 1, 1, qc::otCRZ}))},
    ...
    {"csdg",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCSdg}))},
    {"CSdg",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCSdg}))},

    {"sdg",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otSdg}))},
    {"Sdg",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otSdg}))},
    {"SDG",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otSdg}))},
    ...
    {"tdg",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otTdg}))},
    {"Tdg",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otTdg}))},
    {"TDG",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otTdg}))},
    ...
    {"csx",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCSX}))},
    {"CSX",
     std::make_shared<StandardGate>(StandardGate({1, 1, 0, qc::otCSX}))},

    {"sxdg",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otSXdg}))},
    {"SXdg",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otSXdg}))},
    {"SXDG",
     std::make_shared<StandardGate>(StandardGate({0, 1, 0, qc::otSXdg}))},
    ...
    {"swap",
     std::make_shared<StandardGate>(StandardGate({0, 2, 0, qc::otSWAP}))},
    {"SWAP",
     std::make_shared<StandardGate>(StandardGate({0, 2, 0, qc::otSWAP}))},

    {"cswap",
     std::make_shared<StandardGate>(StandardGate({1, 2, 0, qc::otCSWAP}))},
    {"CSWAP",
     std::make_shared<StandardGate>(StandardGate({1, 2, 0, qc::otCSWAP}))},

    {"c3sqrtx",
     std::make_shared<StandardGate>(StandardGate({1, 3, 0, qc::otC3SQRTX}))},
    {"C3SQRTX",
     std::make_shared<StandardGate>(StandardGate({1, 3, 0, qc::otC3SQRTX}))},
    ...
    {"rxx",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRXX}))},
    {"RXX",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRXX}))},

    {"ryy",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRYY}))},
    {"RYY",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRYY}))},

    {"rzz",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRZZ}))},
    {"RZZ",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRZZ}))},

    {"rzx",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRZX}))},
    {"RZX",
     std::make_shared<StandardGate>(StandardGate({0, 2, 1, qc::otRZX}))},

    {"RCCX",
     std::make_shared<StandardGate>(StandardGate({0, 3, 0, qc::otRCCX}))},
    {"rccx",
     std::make_shared<StandardGate>(StandardGate({0, 3, 0, qc::otRCCX}))},

    {"RC3X",
     std::make_shared<StandardGate>(StandardGate({0, 4, 0, qc::otRC3X}))},
    {"rc3x",
     std::make_shared<StandardGate>(StandardGate({0, 4, 0, qc::otRC3X}))},

    {"C3X",
     std::make_shared<StandardGate>(StandardGate({0, 4, 0, qc::otC3X}))},
    {"c3x",
     std::make_shared<StandardGate>(StandardGate({0, 4, 0, qc::otC3X}))},

    {"dcx",
     std::make_shared<StandardGate>(StandardGate({0, 2, 0, qc::otDCX}))},
    {"DCX",
     std::make_shared<StandardGate>(StandardGate({0, 2, 0, qc::otDCX}))},
    {"ecr",
     std::make_shared<StandardGate>(StandardGate({0, 2, 0, qc::otECR}))},
    {"ECR",
     std::make_shared<StandardGate>(StandardGate({0, 2, 0, qc::otECR}))},
