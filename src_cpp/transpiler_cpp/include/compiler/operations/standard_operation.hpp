...
class StandardOperation : public Operation {
 ...
 public:
  ...
  StandardOperation(const Targets& targ, OpType g,
 ...
 protected:
  ...
  // �ݹ鷽ʽ��ָ�����ΪOriginIR��ʽ
  // �ݹ���ֹ��������ӡ���Ʊ��ء�Ŀ����ء������б�
  // void dump_controlqs_targetqs_param(std::ostream& of, const Controls&
  // controls,const Targets& targets,const std::vector<fp>& parameters)const;
  void dumpOriginIR_controlqs_targetqs_param(
  ...
  void CNOT_dump2originIR(std::ostream& of, std::string cqbit,
                          std::string tqbit) const;
  void SWAP_dump2originIR(std::ostream& of, std::string cqbit,
                          std::string tqbit) const;
  void CZ_dump2originIR(std::ostream& of, std::string cqbit,
                        std::string tqbit) const;
  ...
  void RXX_dump2originIR(std::ostream& of, std::string tqbit1,
                         std::string tqbit2, fp theta) const;
  void RYY_dump2originIR(std::ostream& of, std::string tqbit1,
                         std::string tqbit2, fp theta) const;
  void RZZ_dump2originIR(std::ostream& of, std::string tqbit1,
                         std::string tqbit2, fp theta) const;
  void RZX_dump2originIR(std::ostream& of, std::string tqbit1,
                         std::string tqbit2, fp theta) const;
  void TOFFOLI_dump2originIR(std::ostream& of, std::string cqbit1,
                             std::string cqbit2, std::string tqbit) const;
  void U2_dump2originIR(std::ostream& of, std::string tqbit, fp phi,
                        fp lambda) const;
  void U3_dump2originIR(std::ostream& of, std::string tqbit, fp theta, fp phi,
                        fp lambda) const;
  void CU_dump2originIR(std::ostream& of, std::string cqbit, std::string tqbit,
                        fp theta, fp phi, fp lambda, fp gamma) const;
  // �ݹ����ɵ���
  void C3X_dump2originIR(std::ostream& of, std::string qbit1,
                         std::string qbit2, std::string qbit3,
                         std::string qbit4) const;
  void SDG_dump2originIR(std::ostream& of, std::string tqbit) const;
  void CP_dump2originIR(std::ostream& of, std::string cqbit, std::string tqbit,
                        fp lambda) const;
  void CRX_dump2originIR(std::ostream& of, std::string cqbit,
                         std::string tqbit, fp lambda) const;
  void RCCX_dump2originIR(std::ostream& of, std::string a, std::string b,
                          std::string c) const;
  void RC3X_dump2originIR(std::ostream& of, std::string a, std::string b,
                          std::string c, std::string d) const;
  void TDG_dump2originIR(std::ostream& of, std::string tqbit) const;
  void CSWAP_dump2originIR(std::ostream& of, std::string a, std::string b,
                           std::string c) const;
  void CRY_dump2originIR(std::ostream& of, std::string a, std::string b,
                         fp lambda) const;
  void CRZ_dump2originIR(std::ostream& of, std::string a, std::string b,
                         fp lambda) const;
  void SXDG_dump2originIR(std::ostream& of, std::string tqbit) const;
  void CH_dump2originIR(std::ostream& of, std::string cqbit,
                        std::string tqbit) const;
  ...
  void C3SQRTX_dump2originIR(std::ostream& of, std::string a, std::string b,
                             std::string c, std::string d) const;
  void CU3_dump2originIR(std::ostream& of, std::string cqbit,
                         std::string tqbit, fp theta, fp phi, fp lambda) const;
  void C4X_dump2originIR(std::ostream& of, std::string a, std::string b,
                         std::string c, std::string d, std::string e) const;
  void iSWAP_dump2originIR(std::ostream& of, std::string tqbit1,
                           std::string tqbit2) const;
  void DCX_dump2originIR(std::ostream& of, std::string tqbit1,
                         std::string tqbit2) const;
  void CS_dump2originIR(std::ostream& of, std::string a, std::string b) const;
  void CSdg_dump2originIR(std::ostream& of, std::string a,
                          std::string b) const;
  void CCZ_dump2originIR(std::ostream& of, std::string cqbit1,
                         std::string cqbit2, std::string tqbit) const;
  void ECR_dump2originIR(std::ostream& of, std::string a, std::string b) const;
  void R_dump2originIR(std::ostream& of, std::string tqbit, fp theta,
                       fp phi) const;
  void XXMinusYY_dump2originIR(std::ostream& of, std::string a, std::string b,
                               fp theta, fp beta) const;
  void XXPlusYY_dump2originIR(std::ostream& of, std::string a, std::string b,
                              fp theta, fp beta) const;
  void V_dump2originIR(std::ostream& of, std::string tqbit) const;
  void W_dump2originIR(std::ostream& of, std::string tqbit) const;
  void BARRIER_dump2originIR(std::ostream& of,
                             const RegisterNames& qreg) const;
  /*
  //
  */
