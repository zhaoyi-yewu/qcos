...
StandardOperation::StandardOperation(const Control control,
...
void StandardOperation::dumpOpenQASM(
    ...
    [[maybe_unused]] const RegisterNames& creg, size_t indent,
...
void StandardOperation::dumpOriginIR_bak(
    std::ostream& of, const RegisterNames& qreg,
    [[maybe_unused]] const RegisterNames& creg, size_t indent) const {
  std::ostringstream op;
  op << std::setprecision(std::numeric_limits<fp>::digits10);
  op << std::string(indent * OUTPUT_INDENT_SIZE, ' ');
  ...
  if (!controls.empty())
  {
      ...
      {
          std::cout << "Debug: StandardOperation::dumpOriginIR for() contorls"
  << std::endl; std::cout << "### it:" << it->toString() << std::endl; of <<
  qreg[it->qubit].second;
...
void StandardOperation::dumpOpenQASM2(std::ostream& of, std::ostringstream& op,
  ...
  const bool isSpecialGate =
      type == otPeres || type == otPeresdg || type == otTeleportation;
...
void StandardOperation::dumpOrigin1levelCombineGateType(
...
void StandardOperation::dumpOriginGateType(std::ostream& of,
                                           std::ostringstream& op,
                                           const RegisterNames& qreg) const {
  ...
  if (!targets.empty() && type == otBarrier &&
    ...
    for (auto it = targets.begin(); it != targets.end();) {
      of << " " << qreg[*it].second;
      if (++it != targets.end()) of << ",";
    }
  }

  if (parameter.size() > 0) of << ",";
  ...
  switch (type) {
    ...
    case otTeleportation:
      return;
    default:
      std::cout << "StandardOperation::dumpOriginGateType //print paramerters"
                << std::endl;
      std::cerr << "gate type " << toString(type)
                << " could not be converted to originir\n.";
  }
...
void StandardOperation::dumpOriginSpecialGate(
...
void StandardOperation::I_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "I" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::H_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "H" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::X_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "X" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::Y_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "Y" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::Z_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "Z" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::S_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "S" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::T_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  of << "T" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {});
}
void StandardOperation::CNOT_dump2originIR(std::ostream& of, std::string cqbit,
                                           std::string tqbit) const {
  of << "CNOT" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {cqbit}, {tqbit}, {});
}
void StandardOperation::SWAP_dump2originIR(std::ostream& of,
                                           std::string tqbit1,
                                           std::string tqbit2) const {
  of << "SWAP" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit1, tqbit2}, {});
}
void StandardOperation::CZ_dump2originIR(std::ostream& of, std::string cqbit,
                                         std::string tqbit) const {
  of << "CZ" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {cqbit}, {tqbit}, {});
}
void StandardOperation::RX_dump2originIR(std::ostream& of, std::string tqbit,
                                         fp theta) const {
  of << "RX" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {theta});
}
void StandardOperation::RY_dump2originIR(std::ostream& of, std::string tqbit,
                                         fp theta) const {
  of << "RY" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {theta});
}
void StandardOperation::RZ_dump2originIR(std::ostream& of, std::string tqbit,
                                         fp theta) const {
  of << "RZ" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {theta});
}
void StandardOperation::P_dump2originIR(std::ostream& of, std::string tqbit,
                                        fp theta) const {
  of << "P" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {theta});
}
void StandardOperation::RXX_dump2originIR(std::ostream& of, std::string tqbit1,
                                          std::string tqbit2, fp theta) const {
  of << "RXX" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit1, tqbit2}, {theta});
}
void StandardOperation::RYY_dump2originIR(std::ostream& of, std::string tqbit1,
                                          std::string tqbit2, fp theta) const {
  of << "RYY" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit1, tqbit2}, {theta});
}
void StandardOperation::RZZ_dump2originIR(std::ostream& of, std::string tqbit1,
                                          std::string tqbit2, fp theta) const {
  of << "RZZ" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit1, tqbit2}, {theta});
}
void StandardOperation::RZX_dump2originIR(std::ostream& of, std::string tqbit1,
                                          std::string tqbit2, fp theta) const {
  of << "RZX" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit1, tqbit2}, {theta});
}
void StandardOperation::TOFFOLI_dump2originIR(std::ostream& of,
                                              std::string cqbit1,
                                              std::string cqbit2,
                                              std::string tqbit) const {
  of << "TOFFOLI" << " ";
...
void StandardOperation::U2_dump2originIR(std::ostream& of, std::string tqbit,
                                         fp phi, fp lambda) const {
  of << "U2" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {phi, lambda});
}
void StandardOperation::U3_dump2originIR(std::ostream& of, std::string tqbit,
                                         fp theta, fp phi, fp lambda) const {
  of << "U3" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {}, {tqbit}, {theta, phi, lambda});
}

void StandardOperation::CU_dump2originIR(std::ostream& of, std::string cqbit,
                                         std::string tqbit, fp a, fp b, fp c,
                                         fp d) const {
  of << "CU" << " ";
  dumpOriginIR_controlqs_targetqs_param(of, {cqbit}, {tqbit},
                                        {d + (b + c) / 2, b, a, c});
...
void StandardOperation::C3X_dump2originIR(std::ostream& of, std::string a,
...
void StandardOperation::SDG_dump2originIR(std::ostream& of,
                                          std::string tqbit) const {
  /*
...
void StandardOperation::CP_dump2originIR(std::ostream& of, std::string a,
                                         std::string b, fp lambda) const {
  /*
  gate cu1(lambda) a,b
{
u1(lambda/2) a;
...
void StandardOperation::CRX_dump2originIR(std::ostream& of, std::string a,
                                          std::string b, fp lambda) const {
  /*
  gate crx(lambda) a,b
{
...
void StandardOperation::RCCX_dump2originIR(std::ostream& of, std::string a,
                                           std::string b,
                                           std::string c) const {
  /*
   u2(0,pi) c;
...
void StandardOperation::RC3X_dump2originIR(std::ostream& of, std::string a,
                                           std::string b, std::string c,
                                           std::string d) const {
  /*
...
void StandardOperation::TDG_dump2originIR(std::ostream& of,
                                          std::string tqbit) const {
  // u1(-pi/4) a;
  P_dump2originIR(of, tqbit, -qcPI / 4);
}

void StandardOperation::CSWAP_dump2originIR(std::ostream& of, std::string a,
                                            std::string b,
                                            std::string c) const {
...
void StandardOperation::CRY_dump2originIR(std::ostream& of, std::string a,
                                          std::string b, fp lambda) const {
...
void StandardOperation::CRZ_dump2originIR(std::ostream& of, std::string a,
                                          std::string b, fp lambda) const {
...
void StandardOperation::SXDG_dump2originIR(std::ostream& of,
                                           std::string tqbit) const {
...
void StandardOperation::CH_dump2originIR(std::ostream& of, std::string a,
                                         std::string b) const {
...
void StandardOperation::CY_dump2originIR(std::ostream& of, std::string a,
                                         std::string b) const {
  SDG_dump2originIR(of, b);      // sdg b;
  CNOT_dump2originIR(of, a, b);  // cx a, b;
  S_dump2originIR(of, b);        // s b;
...
void StandardOperation::SX_dump2originIR(std::ostream& of,
                                         std::string a) const {
...
void StandardOperation::CSX_dump2originIR(std::ostream& of, std::string a,
                                          std::string b) const {
  H_dump2originIR(of, b);                // h b;
...
void StandardOperation::C3SQRTX_dump2originIR(std::ostream& of, std::string a,
                                              std::string b, std::string c,
                                              std::string d) const {
...
void StandardOperation::CU3_dump2originIR(std::ostream& of, std::string c,
                                          std::string t, fp theta, fp phi,
                                          fp lambda) const {
  ...
  U3_dump2originIR(
      of, t, -theta / 2, 0,
      -(phi + lambda) / 2);      // u3(-theta / 2, 0, -(phi + lambda) / 2) t;
  CNOT_dump2originIR(of, c, t);  // cx c, t;
  U3_dump2originIR(of, t, theta / 2, phi, 0);  // u3(theta / 2, phi, 0) t;
}

void StandardOperation::C4X_dump2originIR(std::ostream& of, std::string a,
                                          std::string b, std::string c,
                                          std::string d, std::string e) const {
...
void StandardOperation::iSWAP_dump2originIR(std::ostream& of,
                                            std::string tqbit1,
                                            std::string tqbit2) const {
...
void StandardOperation::DCX_dump2originIR(std::ostream& of, std::string a,
                                          std::string b) const {
...
void StandardOperation::CS_dump2originIR(std::ostream& of, std::string a,
                                         std::string b) const {
...
void StandardOperation::CSdg_dump2originIR(std::ostream& of, std::string a,
                                           std::string b) const {
...
void StandardOperation::CCZ_dump2originIR(std::ostream& of, std::string a,
...
void StandardOperation::ECR_dump2originIR(std::ostream& of, std::string a,
                                          std::string b) const {
  // gate ecr a, b {
  //  rzx(pi/4) a, b;
  //  x a;
...
void StandardOperation::R_dump2originIR(std::ostream& of, std::string tqbit,
                                        fp theta, fp phi) const {
  // gate r(θ, φ) a {
  //  u3(θ, φ - π/2, -φ + π/2) a;}
  U3_dump2originIR(of, tqbit, theta, phi - qcPI / 2, qcPI / 2 - phi);
}

void StandardOperation::XXMinusYY_dump2originIR(std::ostream& of,
                                                std::string a, std::string b,
                                                fp theta, fp beta) const {
...
void StandardOperation::XXPlusYY_dump2originIR(std::ostream& of, std::string a,
                                               std::string b, fp theta,
                                               fp beta) const {
...
void StandardOperation::V_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  SDG_dump2originIR(of, tqbit);
  H_dump2originIR(of, tqbit);
}

void StandardOperation::W_dump2originIR(std::ostream& of,
                                        std::string tqbit) const {
  H_dump2originIR(of, tqbit);
  S_dump2originIR(of, tqbit);
}

void StandardOperation::BARRIER_dump2originIR(
    std::ostream& of, const RegisterNames& qreg) const {
  of << "BARRIER" << " ";
  if (targets.size() == 0) {
...
void StandardOperation::dumpOriginIR(
    std::ostream& of, const RegisterNames& qreg,
    [[maybe_unused]] const RegisterNames& creg, size_t indent) const {
  std::ostringstream op;
  op << std::setprecision(std::numeric_limits<fp>::digits10);
  ...
  switch (type) {
    ...
    case otP:
      ...
      break;
    case otRXX:
      RXX_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                        parameter[0]);
      break;
    case otRYY:
      RYY_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                        parameter[0]);
      break;
    case otRZZ:
      RZZ_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                        parameter[0]);
      break;
    case otRZX:
      RZX_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                        parameter[0]);
      break;
    case otTOFFOLI:
      for (auto& ite : controls) {
      ...
      TOFFOLI_dump2originIR(of, cqbit_list[0], cqbit_list[1],
                            qreg[targets[0]].second);
      break;
    case otU2:
      U2_dump2originIR(of, qreg[targets[0]].second, parameter[0],
                       parameter[1]);
      break;
    case otU3:
      U3_dump2originIR(of, qreg[targets[0]].second, parameter[0], parameter[1],
                       parameter[2]);
      break;
    case otCU:
      for (auto& ite : controls) {
      ...
      CU_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
    ...
    case otCU3:
      ...
      CU3_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                        parameter[0], parameter[1], parameter[2]);
      break;
    case otC3X:
      C3X_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                        qreg[targets[2]].second, qreg[targets[3]].second);
      break;
    case otSdg:
    ...
    case otCP:
      ...
      CP_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                       parameter[0]);
      break;
    case otCRX:
      for (auto& ite : controls) {
      ...
      CRX_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                        parameter[0]);
      break;
    case otRCCX:
      RCCX_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                         qreg[targets[2]].second);
      break;
    case otRC3X:
      RC3X_dump2originIR(of, qreg[targets[0]].second, qreg[targets[1]].second,
                         qreg[targets[2]].second, qreg[targets[3]].second);
      break;
    case otTdg:
    ...
    case otCSWAP:
      ...
      CSWAP_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
    ...
    case otCRY:
      ...
      CRY_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                        parameter[0]);
      break;
    case otCRZ:
      for (auto& ite : controls) {
      ...
      CRZ_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                        parameter[0]);
      break;
    case otSXdg:
    ...
    case otC3SQRTX:
      ...
      C3SQRTX_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                            qreg[targets[1]].second, qreg[targets[2]].second);
      break;
    case otC4X:
      for (auto& ite : controls) {
      ...
      C4X_dump2originIR(of, cqbit_list[0], qreg[targets[0]].second,
                        qreg[targets[1]].second, qreg[targets[2]].second,
                        qreg[targets[3]].second);
      break;
    case ot_iSWAP:
      iSWAP_dump2originIR(of, qreg[targets[0]].second,
                          qreg[targets[1]].second);
      break;
    case otDCX:
    ...
    case otCCZ:
      ...
      CCZ_dump2originIR(of, cqbit_list[0], cqbit_list[1],
                        qreg[targets[0]].second);
      break;
    case otECR:
