...
class TestDriverBase:
    ...
    def test_load_driver_configs(self):
        assert obj.load_driver_configs() is None
    ...
    def test_get_extra_configs(self):
        extra_config = obj.get_extra_configs()
        assert extra_config == obj.extra_configs
    ...
    def test_get_driver_info(self):
        ...
        assert driver_info == (
            ...
            f"driver_name: {obj.name}\n"
            f"version: {obj.version}\n"
            f"enable: {obj.enable}\n"
            f"status: {obj._status}\n"
            ...
            f"qpu_configs: {obj.qpu_configs}\n"
            f"decomposition_rule: {obj.decomposition_rule}\n"
            f"extra_configs: {obj.extra_configs}"
        )
    ...
    def test_set_status(self):
        assert obj.set_status("status") is None
        obj.set_status("online")
        assert obj.get_status() == "online"
    ...
    def test_get_qpu_configs(self):
        assert obj.get_qpu_configs() == obj.qpu_configs

    def test_get_decomposition_rule(self):
        assert obj.get_decomposition_rule() == obj.decomposition_rule
    ...
    def test_get_results(self):
        assert obj.get_results() == obj._results
