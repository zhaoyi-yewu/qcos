...
def config(conf):
    ...
    conf['PREFECT']['PREFECT_SERVER_DATABASE_CONNECTION_URL'] = '${PREFECT_SERVER_DATABASE_CONNECTION_URL:-sqlite+aiosqlite:////var/qcos/db/prefect.db?timeout=30&journal_mode=WAL}'
