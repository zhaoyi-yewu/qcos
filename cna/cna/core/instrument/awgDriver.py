...
class SD_Object :
	# 由于jenkins中不存在 libSD1core.so，下句指令在linux中暂时屏蔽
	# __core_dll = cdll.LoadLibrary(GlobalSetting.get_awg_dll() if os.name == 'nt' else "libSD1core.so")

	if os.name == 'nt':
		__core_dll = cdll.LoadLibrary(GlobalSetting.get_awg_dll())
