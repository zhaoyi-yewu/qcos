...
class NAEstimate():
    ...
    Args:
        ...
        single_gate_fidelity (float, optional): 单比特门保真度. Defaults to 0.995.
        multi_gate_fidelity (float, optional): 两比特门保真度. Defaults to 0.98.
    ...
    def estimate_time(self):
        ...
        for opt in self.circuit:
            ...
            if opt.type == 1:
                ...
                continue
            for q in opt.targets: node_time[q] = t+duration
