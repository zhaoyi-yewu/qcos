...
from qcos.transpiler.cmss.wirecut.reconstructor import (
    Reconstructor,
...
class TestReconstructor(unittest.TestCase):
    ...
    @patch(
        "qcos.transpiler.cmss.wirecut.reconstructor.Reconstructor.reconstruct"
    )
    ...
    @patch(
        "qcos.transpiler.cmss.wirecut.reconstructor."
    ...
    def test_compute_tensor_product_for_bases(self, mock_reconstruct):
        ...
        with patch(
            "qcos.transpiler.cmss.wirecut.reconstructor.tensor_product"
    ...
    def test_parse_results_from_hardware_service(self):
        ...
        with patch(
            ...
            with patch(
                "qcos.transpiler.cmss.wirecut.reconstructor.attribute_prob"
