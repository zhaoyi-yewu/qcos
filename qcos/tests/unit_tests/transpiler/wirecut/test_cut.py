...
from qcos.transpiler.cmss.common.gate_operation import H, CX, X, Y, Z
...
class TestCut(unittest.TestCase):
    ...
    @patch(
        "qcos.transpiler.cmss.wirecut.cut.Cut._initialize_gate_depth_encodings"
    )
    @patch(
        "qcos.transpiler.cmss.wirecut.cut.Cut._assign_qubits_to_subcircuits"
    )
    @patch("qcos.transpiler.cmss.wirecut.cut.Cut._update_path_elements")
    @patch("qcos.transpiler.cmss.wirecut.cut.Cut.generate_subcircuits")
