...
from qcos.transpiler.cmss.wirecut.dd import (
    DD,
...
class TestDD(unittest.TestCase):
    ...
    @patch(
        "qcos.transpiler.cmss.wirecut.dd.parse_results_from_hardware_service"
    )
    @patch("qcos.transpiler.cmss.wirecut.dd.asign_probability")
    ...
    @patch("qcos.transpiler.cmss.wirecut.dd.asign_probability")
    @patch("qcos.transpiler.cmss.wirecut.dd.Reconstructor")
    ...
    def test_dd_workflow_with_different_depths(self):
        ...
        with (
            patch(
                "qcos.transpiler.cmss.wirecut.dd."
                "parse_results_from_hardware_service"
            ) as mock_parse_results,
            patch(
                "qcos.transpiler.cmss.wirecut.dd.asign_probability"
    ...
    def test_dd_bins_structure(self):
        ...
        with (
            ...
            patch(
                "qcos.transpiler.cmss.wirecut.dd.Reconstructor"
