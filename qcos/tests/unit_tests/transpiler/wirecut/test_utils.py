...
from qcos.transpiler.cmss.wirecut.utils import (
    asign_probability,
...
from qcos.transpiler.cmss.wirecut.prepare_data import to_basic_init
...
class TestUtils(unittest.TestCase):
    ...
    def test_generate_subcircuits_for_execute(self):
        ...
        with patch(
            "qcos.transpiler.cmss.wirecut.utils."
            "generate_config_circuits_for_one_subcircuit"
    ...
    def test_generate_config_circuits_for_one_subcircuit(self):
        ...
        with patch(
            "qcos.transpiler.cmss.wirecut.utils.generate_measure_plans"
