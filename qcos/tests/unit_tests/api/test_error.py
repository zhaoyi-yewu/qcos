...
class TestError:
    ...
    def test_handle_error_service_unavailable(self):
        with pytest.raises(ServiceUnavailableError) as e:
            handle_error_service_unavailable("module_name", "func_name",
                                             [False, ["err_msg"]])
