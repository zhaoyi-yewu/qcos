...
class TestGetDriver:
    ...
    def test_take_action(self, mock_get_driver,
                         mock_check_results, mock_get_table_data):
        mock_client = Mock(spec=Namespace)
...
class TestGetDevices:
    ...
    def test_take_action(self, mock_get_devices,
                         mock_check_results, mock_get_table_list_data):
        mock_client = Mock(spec=Namespace)
...
class TestGetDevice:
    ...
    def test_take_action(self, mock_get_device,
                         mock_check_results, mock_get_table_data):
        mock_client = Mock(spec=Namespace)
...
class TestGetTranspilers:
    ...
    def test_take_action(self, mock_get_transpilers,
                         mock_check_results, mock_get_table_list_data):
        mock_client = Mock(spec=Namespace)
...
class TestGetTranspiler:
    ...
    def test_take_action(self, mock_get_transpiler,
                         mock_check_results, mock_get_table_data):
        mock_client = Mock(spec=Namespace)
...
class TestGetJobStatus:
    ...
    @patch.object(CommandHelper, "check_results")
    def test_take_action(self, mock_check_results, mock_get_job_status,
                         mock_handle_invalid_arguments, mock_get_table_data):
        mock_check_results.return_value = None
...
class TestGetJobResults:
    ...
    @patch.object(CommandHelper, "check_results")
    def test_take_action(self, mock_check_results, mock_get_job_results,
                         mock_handle_invalid_arguments, mock_get_table_data):
        mock_check_results.return_value = {"results": [{"k1": "v1",
                                                        "k2": "v2"},
                                                       {"k3": "v3"}], }
...
class TestSetJobResults:
    ...
    @patch.object(CommandHelper, "check_results")
    def test_take_action(self, mock_check_results,
                         mock_set_job_results, mock_handle_invalid_arguments):
        mock_check_results.return_value = None
